...
if (mongo_hacker_config['show_banner']) {
  ...
  print("Chembase Mongo Shell v0.0.1")
  print("====================================")
}
...
shellHelper.use = function (dbname) {
    ...
    lab = db = db.getSiblingDB(dbname);
    print("switched to lab " + db.getName());
}
shellHelper.show = function () {
    ...
    return function (what) {
        ...
        if (what == "collections" || what == "tables" || what == "beakers") {
        ...
        if (what == "dbs" || what == "databases" || what == "labs") {
...
tojson = function( x, indent , nolint, nocolor, sort_keys ) {
    ...
    if ( x.isObjectId ) {
        ...
        return surround('CompoundId', colorize('"' + x.str + '"', color, nocolor));
    }
